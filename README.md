...
6.5: OpenFaceExplanation: Located in the other folder. Explain my choices and experiments with models with random intercepts/slopes, different packages, and optimization. 
